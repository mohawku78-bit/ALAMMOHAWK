...
- 2026-06-07 drum-focused extraction: added lightweight drum-band transient scoring to both Kotlin and native tempo engines. The analyzer now scores kick/low drum, snare/clap, and hi-hat bands separately, uses hi-hat mostly as subdivision support, and penalizes fast candidates that look like hat subdivisions without matching kick/snare support.
- 2026-06-07 drum-focused verification: added a regression test for a 112 BPM kick/snare backbeat with loud hi-hats. Targeted `BpmEstimatorTest`, `TempoEngineTest`, and `TempoCandidateCalibratorTest` passed; full `:app:compileDebugKotlin`, `:app:testDebugUnitTest`, `:app:lintDebug`, and `:app:assembleDebug` passed; installed successfully over wireless ADB on Galaxy Tab `SM_T970`. Latest APK SHA-256 is `FE6BB928F4F8A2BBE57A1EF1D6871E462F9E991226CE4B9EF8870054E90C51FC`; latest ZIP SHA-256 is `A1E844273AFA876A16088681AECA7D1FAA8DB18F8F128BA12F93C7BB6B8D8B9E`.
- 2026-06-07 cross-section file consensus: File analysis now aggregates successful analyses from multiple file start positions and prefers BPM values that repeat directly across sections, so a single fast burst is less likely to outrank the same base tempo found later in the track.
- 2026-06-07 cross-section consensus verification: added `TempoSectionAggregatorTest` coverage for repeated-section preference, single-section non-preference, and low-agreement warnings. Targeted `TempoSectionAggregatorTest`/`TempoEngineTest` passed; full `:app:compileDebugKotlin`, `:app:testDebugUnitTest`, `:app:lintDebug`, and `:app:assembleDebug` passed; installed successfully over wireless ADB on Galaxy Tab `SM_T970`. Latest APK SHA-256 is `9E4E8C9DC91527C68620645EDF213EF06D5C632DC062414F75F698F55E43BA69`; latest ZIP SHA-256 is `F539C534860277E0A161C1C53B87E2E51641BA11B7442A975AE19E91895C5A83`.
- 2026-06-07 estimate comparison labels: added `FileEstimateComparator` and UI labels for tapped/public/saved BPM comparison, including close matches, small BPM offsets, half/double-time family matches, and no-reference tap-check language. Full `:app:compileDebugKotlin`, `:app:testDebugUnitTest`, `:app:lintDebug`, and `:app:assembleDebug` passed; installed successfully over wireless ADB on Galaxy Tab `SM_T970`. Latest APK SHA-256 is `DFF714E761D5D5B3BFFD35FDF2A46C0AE7AFB1282E70A847FF4BEF7219896849`; latest ZIP SHA-256 is `90F68F90D8BBA3D13E78B41B4AC5819773A0C3172B53A1BDE268C3583CC7B840`.
- 2026-06-07 tap-vs-auto summary: File Tap now shows a compact summary after tapped BPM is available, distinguishing direct match, small delta, half/double-time family, and large mismatch states. `FileEstimateComparatorTest` was extended for these cases; full compile, unit test, lint, and assemble checks passed; installed successfully over wireless ADB on Galaxy Tab `SM_T970`. Latest APK SHA-256 is `2FC6B8872F3F5DDB3F249283B665B99ABEC899CC874631DE77C83BAAB6D032F8`; latest ZIP SHA-256 is `B4DE2FF19EC9BCF8F6036F72D47DADBB54E6D996ED8F9929415A7BFB988634D1`.
- 2026-06-07 list-row UI reform: redesigned Library saved-track rows and File Tap candidate/reference rows around a compact BPM-first list structure. Advanced record actions now sit behind the More menu, and Needs Review is shown as a small status badge instead of a full-width review strip. Full compile, unit test, lint, and assemble checks passed; installed successfully over wireless ADB on Galaxy Tab `SM_T970`; UI dump verified compact Library rows with BPM, title, artist, category/status/source, and More action. Latest APK SHA-256 is `36D8241074A5D9B904C45DE415348B4380A8F037EB59CCA8B1FF164AA5144C2F`; latest ZIP SHA-256 is `A3C7C3ECBDDBF1896E4C1C08E982E5FBB30AEA479A955749A324AB076BFB6E9D`.
